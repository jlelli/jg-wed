...
const translations = {
  it: {
    ...
    'stay.after.note': 'Lunedì mattina saremo ancora in zona per salutarci con calma: caffè, chiacchiere e lento rientro alla realtà. Magari un salto al mare?',
  ...
  en: {
    ...
    'stay.after.note': 'On Monday morning we\'ll still be around to say goodbye slowly: coffee, chats, and a gentle return to reality. Maybe a dip in the sea?',
